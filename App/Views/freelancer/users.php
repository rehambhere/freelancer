        ...
        <div class="row">
            <div class="col-xs-12 col-sm-4 side">
                <div class="form-container">
                    ...
                    <form action="/en/jobs/create?gid=" method="post" data-track-event="job_posted" data-track-params="job_id">
            ...
            <div class="col-xs-12 col-sm-8 content">
                <div class="info-box info-box--large">
                    <div class="freelancer-list-page">
                        <h3 class="info-box__header">Projects </h3>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <div class="freelancer-details-header">
                                        <a href="user.html">
                                            <h3 class="media-heading"><?php echo $user->first_name . ' - '.$user->last_name;?>
                                    ...
                                    <div class="bio-profile">
                                        <div class="bio-profile">
                                            <p style="width: 500px">
                                                <?php echo read_more($user->info,20);?>....
                                            </p>
                                        </div>
                                    </div>
                                </div>
