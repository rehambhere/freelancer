                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php echo assets('images/'.$user->image)?>" style="width:20px; height:20px" class="img-circle">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                               <img src="<?php echo assets('images/'.$user->image)?>" class="img-circle" alt="User Image">
